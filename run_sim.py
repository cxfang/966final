...
def run_sim(friction, velocity, surface_color, collider_mode, room="empty_room", invisible=False):
    c = Controller()
    screen_width = 1200
    screen_height = 500
    ...
    if velocity == "fast": 
        slider_velocity = {"x": 0, "y": 0, "z": 50} #fastest
    elif velocity == "med":
        slider_velocity = {"x": 0, "y": 0, "z": 37.5} #med
    elif velocity == "slow":
        slider_velocity = {"x": 0, "y": 0, "z": 25} #slowest
